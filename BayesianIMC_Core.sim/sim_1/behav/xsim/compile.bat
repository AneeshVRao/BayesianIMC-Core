...
REM
REM Generated by Vivado on Thu Nov 27 21:50:54 +0300 2025
...
echo "xvlog --incr --relax -prj tb_bayesian_imc_vlog.prj"
call xvlog  --incr --relax -prj tb_bayesian_imc_vlog.prj -log xvlog.log
